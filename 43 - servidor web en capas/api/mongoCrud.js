...
class Mongo {
   ...
   async leer(base, model, num) {
        ...
        logger.error('Error al leer en Mongo:', base, error);
    }
}
...
async guardar(data, model) { 
    ...
    try{
        ...
        logger.error(data)
        logger.error("Error en guardar MONGO");
    }      
 }
 async actualizar(num, toUpdate, model) {
    try{
        ...
        logger.error("error en actualizar MONGO");
    }
 ...
 async borrar(num, model){
     ...
     if(model === "carrito"){
        ...
        logger.error("error en borrar MONGO");
    }
 }
}    
